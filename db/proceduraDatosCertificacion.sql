...
CREATE PROCEDURE `datosCertificacionAddOrEdit` (
  ...
  IN _total_certificacion FLOAT,
  IN _numero_documento VARCHAR(255),
  IN _list_docs_id INT(11),
  IN _totalPlataCerificada FLOAT,
...
BEGIN
  ...
  ELSE
    ...
    totalPlataCerificada = _totalPlataCerificada,
