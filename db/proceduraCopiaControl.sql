...
BEGIN
    ...
    SELECT descripcion_doc,revicion,cantidad_doc,HHUnidades,total,observacion,HH_asociado,proveedor,viatico,numero_documento,porcentajeAvanceAnterior,porcentajeAvanceAcumulado,porcentajeAvancePrecente INTO _descripcion_doc,_revicion,_cantidad_doc,_HHUnidades,_total,_observacion,_HH_asociado,_proveerdor,_viatico,_numero_documento,_porcentajeAvanceAnterior,_porcentajeAvanceAcumulado,_porcentajeAvancePrecente FROM  datosControl WHERE control_id = _id LIMIT _count,1;
    SET _count = _count + 1;
    INSERT INTO datosControl (descripcion_doc, revicion, cantidad_doc, HHUnidades, total, observacion, HH_asociado, proveedor, viatico, control_id, control_cotizacion_id, numero_remito,fecha_envio_remito,list_docs_id,numero_documento,porcentajeAvanceAnterior,porcentajeAvanceAcumulado,porcentajeAvancePrecente)
    VALUES (_descripcion_doc,_revicion,_cantidad_doc,_HHUnidades,_total,_observacion,_HH_asociado,_proveerdor,_viatico,_idControl,_idCoti,NULL,NOW(),_list_docs_id,_numero_documento,_porcentajeAvanceAnterior,_porcentajeAvanceAcumulado,_porcentajeAvancePrecente);
