...
BEGIN
    ...
    SELECT SUM(porcentajeAvanceAnterior + porcentajeAvancePrecente + porcentajeAvanceAcumulado) INTO _porcentajeAvanceAcumuladoSUM FROM  datosControl WHERE control_id = _id LIMIT _count,1;
    SET _count = _count + 1;
    ...
    VALUES (_descripcion_doc,_revicion,_cantidad_doc,_HHUnidades,_total,_observacion,_HH_asociado,_proveerdor,_viatico,_idControl,_idCoti,NULL,NOW(),_list_docs_id,_numero_documento,0,_porcentajeAvancePrecente,_porcentajeAvanceAcumuladoSUM,0);
