...
BEGIN 
  IF _id = 0 THEN
    INSERT INTO list_docs (nombre,cantidad_de_doc, total_hh, especialidad, lista_de_cable, titulo_documento)
    VALUES (_nombre,_cantidad_de_doc, _total_hh, _especialidad, _lista_de_cable, _titulo_documento);
