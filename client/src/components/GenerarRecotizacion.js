...
import SendDataButton from "./button/sendDataButtonRecotizacion";
  ...
  render() {
    return (
      <div>
        ...
        <TableHeaderColumn dataField='codigo_unificador' editable={ false } filter={ { type: 'TextFilter', delay: 1000 } }>codigo_unificador</TableHeaderColumn>
        <TableHeaderColumn dataField='fecha' editable={ false} filter={ { type: 'DateFilter' } }>fecha</TableHeaderColumn>
        <TableHeaderColumn dataField='titulo_cotiazacion' editable={ false } filter={ { type: 'TextFilter', delay: 1000 } }>titulo_cotiazacion</TableHeaderColumn>
        <TableHeaderColumn dataField='numero_doc' editable={ false } filter={ { type: 'TextFilter', delay: 1000 } }>numero_doc</TableHeaderColumn>
        </BootstrapTable>
